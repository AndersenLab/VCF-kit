...
if __name__ == '__main__':
    ...
    ##################
        ...
        if args["wormbase"]:
            reference_download = "ftp://ftp.wormbase.org/pub/wormbase/releases/{asm_name}/species/c_elegans/PRJNA13758/c_elegans.PRJNA13758.{asm_name}.genomic.fa.gz".format(asm_name = args["--ref"])
            import urllib 
